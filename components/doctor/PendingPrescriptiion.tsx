    ...
    <div className='w-[300px]  flex p-2 hover:bg-gray-100'>
      ...
      <div className="">
        ...
        <div className="flex mt-2 text-sm">
          <Button onClick={()=>setShowSummary(true)} className="p-2 h-8 mr-2 rounded-md text-white flex flex-center bg-red-400 hover:bg-red-600">
              <AiOutlineFolderView className='mr-1'/> View Summary
          </Button>
          <Button onClick={()=>setShowPrescription(true)} className="p-2 h-8 rounded-md flex text-white flex-center bg-green-400 hover:bg-green-600">
